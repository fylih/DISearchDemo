 ...
 * 3.2.7. 查询个人信息
 */
public class ExpressionRequest extends Request {
    ...
    public ExpressionRequest(String client_id, String access_token, String scope, String express, String page, String sort_column, String page_row) {
